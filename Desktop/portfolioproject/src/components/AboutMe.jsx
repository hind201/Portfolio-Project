...
import author from '../hindphotocvbaclibre.jpg'
    ...
    return (
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-xm-12">
          ...
          <p>
            Hello! I am Hind. I have been developing websites for over 2 years. I'm Full-Stack Web Developer. Technologies I use is MERN(MongoDB, Express, ReactJS and NodeJS).
